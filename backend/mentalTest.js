document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('surveyForm').addEventListener('submit', function(event) {
      ...
      if (maxMood == "contentment"){
          extraContent = "CONGRATULATIONS!!! You have maintained your mental health properly.<br> Now to keep it healthy, you could perform some yoga positions or play a few mind games."
      }
      if (maxMood == "stress"){
        extraContent = "It looks like you are taking a lot of work up your sleeve (or you are procastinating).<br> Or it could be something about your life. We would recommend to indulge with nature for some time, go for walks, play games like Water Color Sort or Chess to calm yourself"
      }
